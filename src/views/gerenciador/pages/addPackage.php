                        ...
                        <form method="post" enctype="multipart/form-data" action="<?=$base?>/newPackage" class="addUser">
                            <fieldset>
                                ...
                                <div class="campo">
                                    ...
                                    <input type="text" id="link_title" name="link_title" class="input" placeholder="Digite o nome do link externo">
                                </div>
                                <div class="campo">
                                    <label for="link">Link Externo:</label>
                                    <input type="link" id="link" name="link" class="input" placeholder="Digite o url externo do pacote">
                                </div>
