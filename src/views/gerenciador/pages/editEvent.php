            ...
            <div class="container column">
                ...
                <div class="content column">
                    ...
                    <div class="dash-boxes column">
                        ...
                        <form method="post" enctype="multipart/form-data" action="<?=$base;?>/event/<?=$event['id'];?>/editEvent" class="addUser">
                            <fieldset>
                                <legend>
                                ...
                                <div class="campo">
                                    ...
                                    <input type="text" id="title" name="title" class="input" value="<?=$event['title'];?>">
                                </div>
                                <div class="campo">
                                    <label for="description">Descrição:</label>
                                    <input type="text" id="description" name="description" class="input" value="<?=$event['description'];?>">
                                </div>
                                <div class="campo">
                                ...
                                <div class="campo">
                                    ...
                                    <input type="file" id="cover" name="cover" class="input" value="<?=$event['cover'];?>">
                                </div>
                                <div class="campo">
                                ...
                                <div class="campo">
                                    ...
                                    <input type="text" id="link" name="link" class="input" placeholder="Digite o país do pacote de viagem" value="<?=$event['link'];?>">
                                </div>
                                <div class="campo">
                                    <label for="expires_at">Expira em:</label>
                                    <input type="DateTime-Local" id="expires_at" name="expires_at" class="input" placeholder="Digite a data de expiração do pacote de viagem" value="<?=$event['expires_at'];?>">
                                </div>
